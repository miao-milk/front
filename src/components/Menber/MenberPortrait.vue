<template>
    ...
    <div class="text item">买家昵称:{{people.buyerNick}}</div>
    <div class="text item">姓名:{{people.receiverName}}</div>
    <div class="text item">手机号码：{{people.receiverMobile}}</div>
    <div class="text item">性别：{{people.sex}}</div>
    <div class="text item">出生年份：{{people.bornYear}}</div>
    <div class="text item">星座：{{people.constellation}}</div>
    <div class="text item">微信：{{people.we_chat}}</div>
    <div class="text item">qq：{{people.qq}}</div>
    <div class="text item">买家支付宝账号：{{people.buyer_alipay_no}}</div>
    <div class="text item">会员等级：{{people.grade}}</div>
    <div class="text item">交易次数：{{people.buy_total_count}}</div>
    <div class="text item">交易金额：{{people.buy_total_money}}</div>
    <div class="text item">付款件数：{{people.payment_num}}</div>
    <div class="text item">均件数：{{people.avg_num}}</div>
    <div class="text item">最后下单时间：{{people.buyer_last_time}}</div>
    </el-card></el-col>
    </el-row>
    </div>
</template>
...
<script>
	...
	export default {
		...
		mounted() {
        console.log(this.$route.query.sellerId)
       ...
       var  image1= "data:image/png;base64,"
        ...
        //加载图像，将数据放在图像中
        maskResource.onload = function(){ chart.setOption(option)};
    }
	}
</script>
